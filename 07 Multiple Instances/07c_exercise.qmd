...
Let's apply what we've learned about exploratory data analysis. Refer to the lecture slides (`07a_lecture.html`) and the walkthrough code (`07b_walkthrough.R`) as a refresher.
