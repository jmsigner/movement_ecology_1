...
#---------- Module 07 -- Multiple Instances -----------X
#----------------Last updated 2026-02-12---------------X
#-------------------Code Walkthrough-------------------X
#######################################################X
...
# In order to calculate the daily home-range size, we need an other covariate
# (the day when a relocation was observed). We can use the function
# `floor_date(unit = "day")` from the `lubridate` package. This will floor (i.e.
# the times stamp is rounded down to the day).
...
# See `?floor_date` for more information.
